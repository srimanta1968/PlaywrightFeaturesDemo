...
test('Test a webpage HAVING accessibility issues @accessibility', async ({ page }, testInfo) => {
...
test('Test a webpage AFTER FIXING accessibility issues @accessibility', async ({ page }, testInfo) => {
